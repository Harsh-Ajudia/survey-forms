<?php require_once('app/controllers/laboratoryController.php'); ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="container">
            <form method="POST" id="personalDetailsForm">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <input type="text" value="<?php echo isset($formValues['laboratoryName']) ? $formValues['laboratoryName'] : ''; ?>" name="laboratoryName" class="form-control" id="laboratoryName" placeholder="Name of Laboratory">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <input type="text" value="<?php echo isset($formValues['laboratoryCode']) ? $formValues['laboratoryCode'] : ''; ?>" name="laboratoryCode" class="form-control" id="laboratoryCode" placeholder="Laboratory Code">
                        </div>
                    </div>
                    <div class="col-md-4">
