<?php require_once('app/controllers/studentController.php'); ?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <input type="text" value="<?php echo isset($formValues['academicYear']) ? $formValues['academicYear'] : ''; ?>" name="academicYear" class="form-control" id="academicYear" placeholder="Enter Academic Year">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <input type="text" value="<?php echo isset($formValues['subjectName']) ? $formValues['subjectName'] : ''; ?>" name="subjectName" class="form-control" id="subjectName" placeholder="Enter Subject Name">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <input type="text" value="<?php echo isset($formValues['subjectCode']) ? $formValues['subjectCode'] : ''; ?>" name="subjectCode" class="form-control" id="subjectCode" placeholder="Enter Subject Code">
                        </div>
                    </div>
                    <div class="col-md-4">
